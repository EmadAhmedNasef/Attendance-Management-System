...
namespace Attendence_Management.PAL.User_Control
{
    public partial class UserControlAttendence : UserControl
    {
        ...
        {
            string xmlFilePath = @"C:\Users\Nasef\Desktop\Attendance-Management-System-abdellatief\XML\record.xml";
        ...
        private void dataGridViewMarkAttendance_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex == dataGridViewMarkAttendance.Columns["AttendanceColumn"].Index)
            {
                ...
                {
                    XmlDocument xmlDocument = new XmlDocument();
                    xmlDocument.Load(@"C:\Users\Nasef\Desktop\Attendance-Management-System-abdellatief\XML\record.xml");
                    ...
                    if (studentNode != null)
                    {
                        ...
                        xmlDocument.Save(@"C:\Users\Nasef\Desktop\Attendance-Management-System-abdellatief\XML\record.xml");
                    }
                }
                catch (Exception ex)
                {
